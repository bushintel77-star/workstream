...
| 7 | OpenTelemetry tracing for Anthropic, OpenAI, Mapbox, and API route handlers | GAP-ANALYSIS.md | CLOSED in 86db313; route/dictation gaps closed in 4461b28 | Code | Agent | P2 |
| 8 | Edge runtime for `/portal/*` pages | GAP-ANALYSIS.md | CLOSED in 86db313 | Code | Agent | P2 |
| 9 | Route contract smoke coverage extended beyond core health/projects routes | OUTSTANDING.md | CLOSED in 86db313; additional auth/readiness/geocode/supplier/weather/carbon coverage in 4461b28 | Test | Agent | P1 |
...
| 20 | Navigation shell route guards, dev-mode banner, not-found page, and responsive menu verified | User prompt | PARTIAL; dev-mode banner closed in e18c364 | UX | Agent | P2 |
