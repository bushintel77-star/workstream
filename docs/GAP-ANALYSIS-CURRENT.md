...
| 7 | OpenTelemetry tracing for Anthropic, OpenAI, Mapbox, and /v1 route spans | OUTSTANDING.md, GAP-ANALYSIS.md | NOT STARTED | Code | Agent | P2 |
| 8 | Edge runtime for /portal/* pages | OUTSTANDING.md, GAP-ANALYSIS.md | NOT STARTED | Code | Agent | P2 |
| 9 | Contract smoke coverage for remaining API routes beyond core routes | OUTSTANDING.md, apps/api/src/routes/contract.test.ts | PARTIAL | Test | Agent | P1 |
| 10 | Litestream backup setup promoted from template to operator-ready documentation | OUTSTANDING.md, docs/litestream.example.yml | PARTIAL | Doc | Agent | P2 |
| 11 | Mobile app.json EAS placeholder detection and CI guard | apps/mobile/app.json, apps/mobile/eas.json | NOT DONE | Test | Agent | P1 |
| 12 | docs/WORKSTREAM-STATUS.md authoritative status document | User prompt, repository audit | MISSING | Doc | Agent | P2 |
| 13 | Portal loading and error boundaries for client-facing quote/deposit routes | User prompt, web audit | PARTIAL | UX | Agent | P2 |
| 14 | Settings loading boundary and token-only legacy CSS cleanup | User prompt, web audit | PARTIAL | UX | Agent | P2 |
| 15 | Project tab loading skeleton consistency | User prompt, web audit | PARTIAL | UX | Agent | P2 |
