  ...
  return (
    <div
      ...
      style={{
         ...
         * this line on the dock's shoulder. 304 additionally clears the
         * expanded estimator float (280px tall + 16px bottom gutter) — 288
         * clipped its top corner at 1280x720.
         */
        bottom: 304,
