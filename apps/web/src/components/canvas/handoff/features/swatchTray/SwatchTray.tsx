...
/**
 * Fill palette — summoned frost popup on Add/Paint (checklist 2).
 * Anchored beside the tool dock; dismisses when the tool exits.
 */
export function SwatchTray({
  ...
  return (
    <CameraChrome place={{ kind: "dock" }} testId="swatch-tray-chrome">
      <aside
        className={`${css.tray}${night ? ` ${css.trayNight}` : ""}`}
