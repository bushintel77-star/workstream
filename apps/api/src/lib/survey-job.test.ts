...
describe("runSurvey", { timeout: 60_000 }, () => {
  ...
  it(
    "produces a survey with consistent area arithmetic when Vicmap lands",
    async () => {
    ...
    /* Address-keyed title search adds a live WFS round-trip — headroom for
     * parallel related-suite runs. */
    60_000,
  );
